...
namespace NgCooking.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        private CommunauteManager _userManager;

        public AccountController()
        {
        }

        public AccountController(CommunauteManager userManager, ApplicationSignInManager signInManager)
        {
        ...
        public CommunauteManager UserManager
        {
            get
            {
                return _userManager ?? HttpContext.GetOwinContext().GetUserManager<CommunauteManager>();
            }
            private set
            {
                _userManager = value;
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            {
                return PartialView("_LoginView", model);
            }
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new Communaute { UserName = model.Email, Email = model.Email };
